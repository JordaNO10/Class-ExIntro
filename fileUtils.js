...
// Function to append lines to the output file
// function appendLinesToFile(lines, fileName) {
//     const content = lines.join('\n') + '\n';
//     fs.appendFileSync(fileName, content);
//     console.log(`Appended lines to ${fileName}`);
// }


// Function create empty file
// מנקה את קובץ הפלט לפני הכתיבה כדי להבטיח שלא נשאר תוכן מהרצות קודמות
// Clears the output file before writing to ensure no leftover content from previous runs
// function createEmptyFile(fileName) {
//     const textOut = "";
//     fs.writeFileSync(fileName, textOut);
// }